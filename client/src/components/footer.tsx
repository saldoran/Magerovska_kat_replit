          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a
                ...
                className="w-12 h-12 bg-gray-600 hover:bg-pink-500 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-gray-600 hover:bg-green-500 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
