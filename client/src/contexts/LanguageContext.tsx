...
const translations = {
  ...
  'pricing.eyeliner.service.correction': 'Коррекция',
    ...
    'contact.form.service.correction': 'Коррекция',
  ...
  'contact.toast.errorDescription': 'Не удалось отправить заявку. Попробуйте еще раз.',
    ...
    'footer.addressValue': 'Kamienna 19b, L3, 30-001, Kraków, Krowodrza',
    'footer.phone': 'Телефон',
    'footer.phoneValue': '+380938203764',
  ...
  // Portfolio items
  'portfolio.item.1.title': 'Brwi pudrowe',
  'portfolio.item.1.alt': 'Brwi pudrowe - praca mistrzyni Kateriny Magerovskiej',
  'portfolio.item.2.title': 'Lip Blush',
  'portfolio.item.2.alt': 'Lip Blush - makijaż permanentny ust',
  'portfolio.item.3.title': 'Brwi Ombré',
  'portfolio.item.3.alt': 'Technika Ombré dla brwi',
  'portfolio.item.4.title': 'Kreska międzyrzęsna',
  'portfolio.item.4.alt': 'Tatuaż międzyrzęsny',
  'portfolio.item.5.title': 'Korekta brwi',
  'portfolio.item.5.alt': 'Korekta kształtu i koloru brwi',
  'portfolio.item.6.title': 'Efekty pracy',
  'portfolio.item.6.alt': 'Efekty pracy mistrzyni',
  // Testimonials
  ...
  'testimonials.item.3.text': 'Długo szukałam mistrza do makijażu permanentnego i nie żałuję wyboru Katii. Bardzo dokładna, staranna praca, świetny efekt. Na pewno wrócę na korektę i inne zabiegi!',
    ...
    'contact.form.service.correction': 'Korekta',
  ...
  'portfolio.item.6.alt': "Master's work results",
    ...
    'contact.form.service.correction': 'Correction',
  ...
  uk: {
    ...
    'contact.form.service.correction': 'Корекція',
